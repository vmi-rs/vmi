...
//! monitor certain events in a Windows guest running inside a KVM virtual
//! machine.
//!
...
//!
//! ```text
//! cargo run --features="arch-amd64 driver-kvm os-windows utils" --example kvm-windows-reactor -- <qemu pid>
//! ```
//!
//! # Possible log output
//!
//! ```text
//!  INFO setting up VMI pid=2233151
