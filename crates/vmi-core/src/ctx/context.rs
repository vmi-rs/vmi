    ...
    Os: VmiOs<Driver>,
{
    ...
    pub fn new(
        ...
        Self {
            state: VmiState::new(session, event.registers()),
            event,
        }
    }
...
/*
/// A VMI context prober.
pub type VmiContextProber<'a, Driver, Os> = VmiStateProber<'a, Driver, Os>;

/// A VMI OS context prober.
pub type VmiOsContextProber<'a, Driver, Os> = VmiOsStateProber<'a, Driver, Os>;
*/
