...
constexpr uint32_t  BRIDGE_MAGIC = 0x42494d56;
constexpr uint16_t  PULL_REQUEST = 0x0001;
constexpr uintptr_t BRIDGE_VERIFY_VALUE3 = 0x213353522d494d56;
constexpr uintptr_t BRIDGE_VERIFY_VALUE4 = 0x213453522d494d56;
...
public:
    ...
    explicit Variant(LONG lValue) : Variant{}
    {
        this->vt = VT_I4;
        this->lVal = lValue;
    }

    explicit Variant(LPCWSTR wszValue) : Variant{}
    {
        this->vt = VT_BSTR;
        this->bstrVal = SysAllocString(wszValue);
    }

    explicit Variant(IDispatch* pDispatch) : Variant{}
    {
        this->vt = VT_DISPATCH;
...
auto
ExtractInternal(
    LPCWSTR wszArchivePath,
    LPCWSTR wszOutputPath
